...
async function createMainWindow() {
  ...
  if (isDev) {
    // Prioritize common Vite ports - 5173 is the default Vite port
    const ports = [5173, 3000, 6969, 6970, 6971, 6972, 6973, 6974, 6975, 6976, 6977, 6978];
    let loaded = false;
  ...
  mainWindow.webContents.on('did-fail-load', (event, errorCode, errorDescription) => {
    ...
    if (isDev) {
      setTimeout(() => {
        console.log('Attempting to reload from Vite default port (5173)...')
        // Try to reload from the Vite default port
