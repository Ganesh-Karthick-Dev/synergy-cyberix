      ...
      {showHelpDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full mx-4 p-6 max-h-[80vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Network Scanning Help</h3>
              <button
            ...
            <div className="text-gray-700 dark:text-gray-300 space-y-4">
              <p>Network Scanning allows you to perform comprehensive security analysis of target hosts using Kali Linux tools.</p>
              <div>
                <h4 className="font-semibold mb-2">Features:</h4>
                <ul className="list-disc list-inside space-y-1">
                  <li>WhatWeb technology detection</li>
                  <li>Ping connectivity tests</li>
                  <li>Hping3 port scanning</li>
                  <li>DNS resolution and IP extraction</li>
                  <li>Nmap host discovery and port scanning</li>
